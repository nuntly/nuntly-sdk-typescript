...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=@nuntly/sdk-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkBudW50bHkvc2RrLW1jcCJdLCJlbnYiOnsiTlVOVExZX0FQSV9LRVkiOiJTZXQgeW91ciBOVU5UTFlfQVBJX0tFWSBoZXJlLiJ9fQ)
...
```
claude mcp add --transport stdio nuntly_sdk_api --env NUNTLY_API_KEY="Your NUNTLY_API_KEY here." -- npx -y @nuntly/sdk-mcp
```
