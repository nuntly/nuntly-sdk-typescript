...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ id: string; createdAt: string; shortToken: string; status: 'enabled' | 'disabled' | 'revoked'; name?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/api-keys/$ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; apiKey: string; shortToken: string; status: 'enabled' | 'disabled' | 'revoked'; name?: string; }",
  ...
  },
  {
    ...
    "description": "Remove a domain from the organization. Cannot be deleted if it has active sending or receiving.",
  ...
  },
  {
    ...
    "response": "{ id: string; createdAt: string; name: string; receivingStatus: 'disabled' | 'bootstrapping' | 'pending' | 'active' | 'failed'; region: 'eu-west-1'; sendingStatus: 'enabled' | 'disabled' | 'paused'; status: 'bootstrapping' | 'pending' | 'success' | 'failed' | 'temporary_failure'; }",
  ...
  },
  {
    ...
    "response": "{ id: string; createdAt: string; from: string; orgId: string; status: string; subject: string; to: string[] | string; attachments?: { contentType?: string; filename?: string; size?: number; }[]; bcc?: string[] | string; bulkId?: string; cc?: string[] | string; headers?: object; messageId?: string; replyTo?: string[] | string; scheduledAt?: string; statusReason?: object; tags?: { name: string; value: string; }[]; variables?: object; }",
  ...
  },
  {
    ...
    "response": "{ id: string; createdAt: string; from: string; status: string; subject: string; to: string[] | string; scheduledAt?: string; }",
  ...
  },
  {
    ...
    "description": "Send up to 100 emails in a single request. Use `fallback` to set default values shared across all messages.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/emails/bulk \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\" \\\n    -d '{\n          \"emails\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/emails/bulk/$BULK_ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; createdAt: string; emailId: string; eventType: string; orgId: string; payload: object; occurredAt?: string; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/emails/$ID/events \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/emails/$ID/content \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/emails/stats \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; activeInboxCount: number; createdAt: string; externalId: string; inboxCount: number; name: string; updatedAt?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/namespaces/$NAMESPACE_ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; address: string; agentId: string; createdAt: string; domainId: string; domainName: string; name: string; namespaceId: string; namespaceName: string; updatedAt?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/namespaces/$NAMESPACE_ID/inboxes \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/inboxes/$INBOX_ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/inboxes/$INBOX_ID/messages \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\" \\\n    -d '{\n          \"subject\": \"x\",\n          \"to\": [\n            \"dev@stainless.com\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; agentId: string; createdAt: string; domainId: string; domainName: string; inboxId: string; labels: string[]; lastMessageAt: string; messageCount: number; subject: string; updatedAt?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/inboxes/$INBOX_ID/threads \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/threads/$THREAD_ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; attachmentCount: number; bcc: string[]; cc: string[]; createdAt: string; from: string; labels: string[]; messageId: string; receivedAt: string; replyTo: string[]; status: 'received' | 'sent' | 'discarded' | 'failed'; subject: string; threadId: string; to: string[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/threads/$THREAD_ID/messages \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; attachmentCount: number; bcc: string[]; cc: string[]; createdAt: string; from: string; inboxId: string; labels: string[]; messageId: string; receivedAt: string; replyTo: string[]; status: 'received' | 'sent' | 'discarded' | 'failed'; subject: string; threadId: string; to: string[]; }",
  ...
  },
  {
    ...
    "response": "{ id: string; attachmentCount: number; bcc: string[]; cc: string[]; createdAt: string; from: string; headers: object; inboxId: string; labels: string[]; messageId: string; receivedAt: string; replyTo: string[]; status: 'received' | 'sent' | 'discarded' | 'failed'; subject: string; threadId: string; to: string[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/messages/$MESSAGE_ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/messages/$MESSAGE_ID/reply \\\n    -X POST \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/messages/$MESSAGE_ID/forward \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\" \\\n    -d '{\n          \"to\": [\n            \"dev@stainless.com\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ html: { downloadUrl: string; expiresAt: string; size: number; }; mime: { downloadUrl: string; expiresAt: string; size: number; }; text: { downloadUrl: string; expiresAt: string; size: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/messages/$MESSAGE_ID/content \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; contentDisposition: string; contentId: string; contentType: string; filename: string; size: number; downloadUrl?: string; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/messages/$MESSAGE_ID/attachments \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/messages/$MESSAGE_ID/attachments/$ATTACHMENT_ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; agentId: string; createdAt: string; inboxId: string; memory: object; summary: string; threadId: string; updatedAt?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/agents/$AGENT_ID/memory \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; createdAt: string; endpointUrl: string; events: string[]; status: 'enabled' | 'disabled' | 'revoked'; name?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/webhooks/$ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; createdAt: string; endpointUrl: string; events: string[]; signingSecret: string; status: 'enabled' | 'disabled' | 'revoked'; name?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/webhooks/$ID/events/$EVENT_ID/replay \\\n    -X POST \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; code: string; deliveredAt: string; response: object; status: 'pending' | 'success' | 'failed'; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/webhooks/$ID/events/$EVENT_ID/deliveries \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; data: object; event: string; orgId: string; status: 'success' | 'pending' | 'failed'; webhookId: string; successfulAt?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/webhooks/events \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/organizations \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/organizations/$ID \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ transactional: { limits: { daily: number; monthly: number; }; receiving: { daily: number; monthly: number; }; sending: { daily: number; monthly: number; }; usage: { daily: number; monthly: number; }; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.nuntly.com/organizations/$ID/usage \\\n    -H \"Authorization: Bearer $NUNTLY_API_KEY\""
      }
    }
  }
];
