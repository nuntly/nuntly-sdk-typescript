...
export const handler = async (client: Nuntly, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.organizations.invitations.list(id, body).asResponse();
