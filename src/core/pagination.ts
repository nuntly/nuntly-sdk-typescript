...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: Nuntly, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
...
export class CursorPage<Item> extends AbstractPage<Item> implements CursorPageResponse<Item> {
  ...
  constructor(client: Nuntly, response: Response, body: CursorPageResponse<Item>, options: FinalRequestOptions) {
