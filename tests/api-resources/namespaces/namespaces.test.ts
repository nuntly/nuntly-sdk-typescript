...
describe('resource namespaces', () => {
  test('create: only required params', async () => {
    const responsePromise = client.namespaces.create({ name: 'x' });
  ...
  test('create: required and optional params', async () => {
    const response = await client.namespaces.create({ name: 'x', externalId: 'externalId' });
  });

  test('retrieve', async () => {
    const responsePromise = client.namespaces.retrieve('ns_01kabn43yqyxn2bx4ve84mczd3');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('update', async () => {
    const responsePromise = client.namespaces.update('ns_01kabn43yqyxn2bx4ve84mczd3');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete', async () => {
    const responsePromise = client.namespaces.delete('ns_01kabn43yqyxn2bx4ve84mczd3');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
