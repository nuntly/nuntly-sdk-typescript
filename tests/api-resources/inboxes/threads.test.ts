...
describe('resource threads', () => {
  test('list', async () => {
    const responsePromise = client.inboxes.threads.list('ibx_01kabn43yqyxn2bx4ve84mczd3');
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.inboxes.threads.list('ibx_01kabn43yqyxn2bx4ve84mczd3', {
    cursor: 'cursor',
    labels: 'labels',
    limit: 1,
