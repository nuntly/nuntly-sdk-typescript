...
* clarify forwards compat behavior ([5ffff7a](https://github.com/nuntly/nuntly-sdk-typescript/commit/5ffff7a8455e16e732a28e842d43eeccb0b6dc3a))
* update with proxy auth info ([21ae8fa](https://github.com/nuntly/nuntly-sdk-typescript/commit/21ae8fa565b6e568e244da6e1c658f3eb32ef94f))
...
* **api:** rename template "context" field to "variables" ([a7127b0](https://github.com/nuntly/nuntly-sdk-typescript/commit/a7127b02c690779d2c16488d8cfac2c0374defc8))
...
* **api:** inbound email ([7da9a89](https://github.com/nuntly/nuntly-sdk-typescript/commit/7da9a89b319c306a1b8a1a5138787317e5ca8f13))
...
* **mcp:** add an option to disable code tool ([7dba64a](https://github.com/nuntly/nuntly-sdk-typescript/commit/7dba64ae2ade8ed482bdbc958e1261f2e1586546))
...
* **client:** preserve URL params already embedded in path ([13a7108](https://github.com/nuntly/nuntly-sdk-typescript/commit/13a7108cbd167f4c66449bf8503523878eb28660))
...
* **docs/contributing:** correct pnpm link command ([1d76e0f](https://github.com/nuntly/nuntly-sdk-typescript/commit/1d76e0ffb035b3cfdf1c61f079dace7cac383c9e))
...
* **mcp:** update prompt ([2b81a74](https://github.com/nuntly/nuntly-sdk-typescript/commit/2b81a74dae004e443198d3006d030c4bf17932a6))
...
* **ci:** skip uploading artifacts on stainless-internal branches ([3a83aee](https://github.com/nuntly/nuntly-sdk-typescript/commit/3a83aee98bfac36f9ec37f0f40e2d2ea2b8d7f7f))
...
* **internal:** codegen related update ([a90e9da](https://github.com/nuntly/nuntly-sdk-typescript/commit/a90e9daed8dbc5fce4b778500796367916dcea92))
* **internal:** codegen related update ([28d40d2](https://github.com/nuntly/nuntly-sdk-typescript/commit/28d40d2e1c135b17ee7abcf7a6e7e238991af046))
...
* **internal:** fix MCP Dockerfiles so they can be built without buildkit ([88bd3e8](https://github.com/nuntly/nuntly-sdk-typescript/commit/88bd3e81611fb2c359c160646aa7eb31e76a2dd7))
* **internal:** fix MCP Dockerfiles so they can be built without buildkit ([e15b81b](https://github.com/nuntly/nuntly-sdk-typescript/commit/e15b81b57a57db34351f3bccfcccade55faf75f3))
...
* **internal:** make MCP code execution location configurable via a flag ([4f24c19](https://github.com/nuntly/nuntly-sdk-typescript/commit/4f24c190f1d29df8ff27ffde56ca0ce527d1c8d2))
...
* **internal:** move stringifyQuery implementation to internal function ([050d63b](https://github.com/nuntly/nuntly-sdk-typescript/commit/050d63bbb5f7fc63d0b328476fb37dc14445100e))
...
* **internal:** update dependencies to address dependabot vulnerabilities ([90869fa](https://github.com/nuntly/nuntly-sdk-typescript/commit/90869fad85ce80fbeee10f01bd60c1cabbf63bbb))
...
* **internal:** upgrade @modelcontextprotocol/sdk and hono ([6bc9a84](https://github.com/nuntly/nuntly-sdk-typescript/commit/6bc9a84b4148e89d2926c985fc5e0cec79069055))
...
* **internal:** use x-stainless-mcp-client-envs header for MCP remote code tool calls ([9e39c19](https://github.com/nuntly/nuntly-sdk-typescript/commit/9e39c19265cbbd666ac0595881f9cb398a87c5c2))
...
* **mcp-server:** improve instructions ([f318432](https://github.com/nuntly/nuntly-sdk-typescript/commit/f318432da7f972aa487b856dff6316896232b4ba))
* **mcp-server:** return access instructions for 404 without API key ([57933d6](https://github.com/nuntly/nuntly-sdk-typescript/commit/57933d6c473c1ab2d227fb2ca1803217d1118263))
...
* **test:** do not count install time for mock server timeout ([70becd6](https://github.com/nuntly/nuntly-sdk-typescript/commit/70becd66f73cce51d4f62b509e83f2b613be8ff6))
